...
@st.cache_data
def load_data():
    cleaned_df = pd.read_csv(r"C:\Users\z031906\OneDrive - Alliance\Desktop\AIML\Mini Project 4 - Swiggy\cleaned_data.csv")
    encoded_df = pd.read_csv(r"C:\Users\z031906\OneDrive - Alliance\Desktop\AIML\Mini Project 4 - Swiggy\encoded_data.csv")
    with open(r"C:\Users\z031906\OneDrive - Alliance\Desktop\AIML\Mini Project 4 - Swiggy\encoder.pkl", "rb") as f:
